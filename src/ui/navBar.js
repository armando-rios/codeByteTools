...
function setActive(event) {
  sections.forEach(a => a.classList.remove("bg-surface0", "text-lavander", "active"))
...
const baseStyle = "font-medium text-lg px-2 py-1 rounded-lg duration-300 transition-all scale-100 cursor-pointer w-56 text-center p-2"
